# License Compat Matrix

> License compatibility matrix for dependency graphs

**Author:** zAx4hub

## Problem

License compatibility matrix for dependency graphs. Teams often rely on closed SaaS, brittle scripts, or untested prototypes for this niche.

## Solution

`license-compat-matrix` is an installable TypeScript/Node toolkit by **zAx4hub** with a real **graph** engine, CLI, examples, and tests.
